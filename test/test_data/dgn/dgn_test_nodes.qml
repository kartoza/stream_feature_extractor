...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="ART" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="3" value="Senke" label="Senke"/>
      <category symbol="4" value="Top" label="Top"/>
      <category symbol="5" value="Ungetrennter" label="Ungetrennter"/>
      <category symbol="6" value="Unklare Bifurkation" label="Unklare Bifurkation"/>
      <category symbol="7" value="Verzweigung" label="Verzweigung"/>
      <category symbol="8" value="Zusammenfluss" label="Zusammenfluss"/>
    </categories>
    <symbols>
